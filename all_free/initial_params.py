...
def init_cond_cls (model): 
    if model == 'gnfw_circ+beta_circ':
        ...
        A_main = [700, 1000] #[70, 90] #[50,1000]     # First Cluster Amplitude (counts)
        A_sub = [200, 400] #[10,30] #[10, 300]      # Second Cluster Amplitude (counts)
        return x_main, y_main, x_sub, y_sub, rs_main, rc_sub, alpha_main, beta_main, gamma_main, beta_sub, A_main, A_sub #
