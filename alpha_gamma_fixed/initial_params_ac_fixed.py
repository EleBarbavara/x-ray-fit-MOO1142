...
def init_cond_cls (model): 
    if model == 'gnfw_circ+beta_circ':
        #x_main = [51, 55] #for rectangular image #main cluster 53.58, 40.18 from x-ray chandra (?)
        #y_main = [38, 42] #for rectangular image
        x_sub = [35,65]#[48, 52] #[63, 67] for rectangular image #sub cluster 64.87, 44.03 from x-ray chandra (?)
        y_sub = [30, 60] #[44, 47] #for rectangular image
        ...
        A_sub = [1,300] #[10, 30] #[10,300]     # Second Cluster Amplitude (counts)
