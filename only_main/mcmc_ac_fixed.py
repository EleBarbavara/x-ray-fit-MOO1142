...
if fit_method == 'gnfw_ell':
    ...
    autocorr_angle_main=np.empty(Nsamples)
    autocorr_ecc_main=np.empty(Nsamples)
...
with (Pool(ncores)) as pool:
    ...
    for k in range(N_check):
        ...
        if fit_method == 'gnfw_ell':
            ...
            autocorr_angle_main[index]=tau[3]
            autocorr_ecc_main[index]=tau[4]
            autocorr_beta_main[index]=tau[5]
            autocorr_A_main[index]=tau[6]
            autocorr_a_bkg[index]=tau[7]
